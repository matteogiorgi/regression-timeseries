...
\author{\textbf{Group 10}\\\textit{The Random Walkers}}
\date{\today}
...
\begin{frame}{Interpretation of the Regression Results}
  \begin{itemize}
    ...
    \item Interpretation: for each one–point increase in the AI adoption index, the number of layoffs increases on average by about 1.43 employees.
